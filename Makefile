# Makefile for Find My Buddy API Docker operations
...
.PHONY: help
help:
	@echo "${YELLOW}Find My Buddy API Docker Commands${NC}"
	...
	@echo "${GREEN}make migration-run${NC}   - Run database migrations"
